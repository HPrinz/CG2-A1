...
define([ "util", "vec2", "scene", "point_dragger", "radius_dragger" ], (function(Util, vec2, Scene, PointDragger, RadiusDragger) {

	"use strict";

	/**
	 * A simple circle thats radius can be scaled by one point. It can be move by its center point Parameters: - center:
	 * array object representing [x,y] coordinates of center point - radius: number representing the radius of the
	 * circle - lineStyle: object defining width and color attributes for line drawing, begin of the form { width: 2,
	 * color: "#00FF00" }
	 */
	var Circle = function(center, radius, lineStyle) {

		console.log("Creating circle with center point[" + center[0] + "," + center[1] + "] and radius " + radius + ".");
	...
	/**
	 * Return list of draggers to manipulate this circle. we have 1 PointDragger and 1 RadiusDragger for each circle.
	 */
